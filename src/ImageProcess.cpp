...
ImageProcess::ImageProcess(Size _videoSize)
{
	imgSize = _videoSize;
}
...
void ImageProcess::startProcessing(Mat& _frame,int _morphmode)
{
	// 영상을 그레이
	...
	morphologyEx(_frame, _frame, _morphmode, Mat(9, 9, CV_8U));
